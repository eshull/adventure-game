class Play  < ActiveRecord::Base
  def self.game()
    ...
    Artifact.create({:room_id => nil, :portable => true, :hidden => true, :obscures => false, :name => 'key', :origin => 'Study', :purpose => 'Hallway', :unlock => 'use, turn, insert', :description => 'a plain grey skeleton key'})
    ...
    Artifact.create({:room_id => nil, :portable => false, :hidden => false, :obscures => false, :name => 'crate', :origin => 'Library', :purpose => 'waste of time', :unlock => nil, :description => 'this crate of books would take decades to read through. Say, did that plant get a little closer to you just now?'})
    ...
    Artifact.create({:room_id => nil, :portable => true, :hidden => false, :obscures => false, :name => 'purse', :origin => 'Bathroom', :purpose => 'waste of time', :unlock => nil, :description => 'an everyday purse, with assorted tissues, lipsticks, and a voucher for two-for-one sandwiches at Shull Deli which expired June 30th, 1922.'})
    ...
    Artifact.create({:room_id => nil, :portable => true, :hidden => false, :obscures => false, :name => 'spinner', :origin => 'Dark Basement', :purpose => 'waste of time', :unlock => nil, :description => 'Hmm. A fidget spinner. Now... how did this get in here?'})
