...
Artifact.create({:room_id => 2, :portable => false, :hidden => false, :obscures => true, :name => 'well', :purpose => 'penny', :unlock => 'look, search, check, inspect, open', :description => 'a very old well, now mostly filled with trash.'})
Artifact.create({:room_id => 2, :portable => false, :hidden => false, :obscures => false, :name => 'book', :purpose => 'waste of time', :unlock => nil, :description => 'A copy of the 1923 reprint of the wildly successful Esperanto verion of Wuthering Heights. It\'s open to the section of the story where young Werther and Oscar Wilde decide to build the first flying machine together, but decide to do that later- after they elope.'})

Artifact.create({:room_id => 11, :portable => false, :hidden => false, :obscures => true, :name => 'jacket', :purpose => 'dagger', :unlock => 'search, check, inspect, open', :description => 'a nicely made suede jacket.'})
Artifact.create({:room_id => 11, :portable => true, :hidden => true, :obscures => false, :name => 'dagger', :purpose => 'open door in room 23', :unlock => 'use, turn, insert', :description => 'a shiny silver dagger. This looks like trouble.'})
Artifact.create({:room_id => 11, :portable => false, :hidden => false, :obscures => true, :name => 'desk', :purpose => '2', :unlock => 'search, check, inspect, open', :description => 'a dusty desk covered in paperwork and stationery.'})
Artifact.create({:room_id => 11, :portable => false, :hidden => true, :obscures => false, :name => 'key', :purpose => 'open door in room 23', :unlock => 'use, turn, insert', :description => 'a plain grey skeleton key'})
Artifact.create({:room_id => 2, :portable => false, :hidden => false, :obscures => false, :name => 'folded map', :purpose => 'waste of time', :unlock => nil, :description => 'a mildly tattered copy of the 1978 Shell Oil Roadmap of Florida. Probably not so helpful. Good luck folding it back up.'})
